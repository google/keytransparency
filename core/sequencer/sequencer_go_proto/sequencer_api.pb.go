...
func (*CreateEpochRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_sequencer_api_1bdb5ac8f17657f4, []int{0}
}
...
// RunBatchRequest describes the size of a batch for a given domain.
type RunBatchRequest struct {
	// domain_id is the domain to run.
	DomainId string `protobuf:"bytes,1,opt,name=domain_id,json=domainId,proto3" json:"domain_id,omitempty"`
...
func (*RunBatchRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_sequencer_api_1bdb5ac8f17657f4, []int{1}
}
...
type KeyTransparencySequencerClient interface {
	// RunBatch reads oustanding mutations and calls CreateEpoch.
...
func init() { proto.RegisterFile("sequencer_api.proto", fileDescriptor_sequencer_api_1bdb5ac8f17657f4) }

var fileDescriptor_sequencer_api_1bdb5ac8f17657f4 = []byte{
