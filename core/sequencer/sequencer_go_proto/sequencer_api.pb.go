...
type DefineRevisionsResponse struct {
	// map_revision is the current map revision that was fully applied. Any
	// unapplied revisions are greater than map_revision.
	MapRevision int64 `protobuf:"varint,2,opt,name=map_revision,json=mapRevision,proto3" json:"map_revision,omitempty"`
	// old_defined is the last defined revision before this call. Any newly
	// defined revisions are greater than old_defined.
	OldDefined int64 `protobuf:"varint,3,opt,name=old_defined,json=oldDefined,proto3" json:"old_defined,omitempty"`
	// new_defined is the last defined revision after this call. No new revisions
	// are defined if new_defined <= old_defined.
	NewDefined           int64    `protobuf:"varint,4,opt,name=new_defined,json=newDefined,proto3" json:"new_defined,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *DefineRevisionsResponse) GetMapRevision() int64 {
	if m != nil {
...
func (m *DefineRevisionsResponse) GetOldDefined() int64 {
	if m != nil {
		return m.OldDefined
	}
	return 0
...
func (m *DefineRevisionsResponse) GetNewDefined() int64 {
	if m != nil {
		return m.NewDefined
	}
	return 0
...
var fileDescriptor_0a5d61b2e27141ee = []byte{
	...
	,
}
