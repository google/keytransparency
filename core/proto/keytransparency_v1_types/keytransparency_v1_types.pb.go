...
// MutationProof contains the information nessesary to compute the new leaf value.
// It contains the a) old leaf value with it's inclusion proof and b) the mutation.
...
func (*MutationProof) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
var fileDescriptor0 = []byte{
	...
	,
}
