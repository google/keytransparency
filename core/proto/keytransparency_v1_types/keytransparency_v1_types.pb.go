...
type GetMutationsResponse struct {
	...
	LogRoot *trillian1.GetLatestSignedLogRootResponse `protobuf:"bytes,3,opt,name=log_root,json=logRoot" json:"log_root,omitempty"`
	// log_consistency proves that log_root is consistent with previously seen roots.
	LogConsistency *trillian1.GetConsistencyProofResponse `protobuf:"bytes,4,opt,name=log_consistency,json=logConsistency" json:"log_consistency,omitempty"`
	// log_inclusion proves that smr is part of log_root at index=srm.MapRevision.
	LogInclusion *trillian1.GetInclusionProofResponse `protobuf:"bytes,5,opt,name=log_inclusion,json=logInclusion" json:"log_inclusion,omitempty"`
...
func (m *GetMutationsResponse) GetLogRoot() *trillian1.GetLatestSignedLogRootResponse {
	if m != nil {
		return m.LogRoot
	}
	return nil
...
func (m *GetMutationsResponse) GetLogConsistency() *trillian1.GetConsistencyProofResponse {
	if m != nil {
...
func (m *GetMutationsResponse) GetLogInclusion() *trillian1.GetInclusionProofResponse {
	if m != nil {
...
var fileDescriptor0 = []byte{
	...
	,
}
