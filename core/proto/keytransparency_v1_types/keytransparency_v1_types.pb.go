...
import trillian2 "github.com/google/trillian"
...
type Mutation struct {
	...
	Proof *trillian2.MapLeafInclusion `protobuf:"bytes,2,opt,name=proof" json:"proof,omitempty"`
}
...
func (m *Mutation) GetProof() *trillian2.MapLeafInclusion {
	if m != nil {
		return m.Proof
	}
	return nil
...
type GetEntryResponse struct {
	...
	// Tree.
	LeafProof *trillian2.MapLeafInclusion `protobuf:"bytes,5,opt,name=leaf_proof,json=leafProof" json:"leaf_proof,omitempty"`
	...
	LogRoot *trillian1.GetLatestSignedLogRootResponse `protobuf:"bytes,7,opt,name=log_root,json=logRoot" json:"log_root,omitempty"`
	// log_consistency proves that log_root is consistent with previously seen roots.
	LogConsistency *trillian1.GetConsistencyProofResponse `protobuf:"bytes,8,opt,name=log_consistency,json=logConsistency" json:"log_consistency,omitempty"`
	// log_inclusion proves that smr is part of log_root at index=srm.MapRevision.
	LogInclusion *trillian1.GetInclusionProofResponse `protobuf:"bytes,9,opt,name=log_inclusion,json=logInclusion" json:"log_inclusion,omitempty"`
}
...
func (m *GetEntryResponse) GetLeafProof() *trillian2.MapLeafInclusion {
	if m != nil {
		return m.LeafProof
	}
	return nil
...
func (m *GetEntryResponse) GetLogRoot() *trillian1.GetLatestSignedLogRootResponse {
	if m != nil {
		return m.LogRoot
	}
	return nil
...
func (m *GetEntryResponse) GetLogConsistency() *trillian1.GetConsistencyProofResponse {
	if m != nil {
...
func (m *GetEntryResponse) GetLogInclusion() *trillian1.GetInclusionProofResponse {
	if m != nil {
...
var fileDescriptor0 = []byte{
	...
	,
}
