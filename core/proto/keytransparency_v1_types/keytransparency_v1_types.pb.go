...
type GetMutationsRequest struct {
	...
	// value means start from the beginning. A non-empty value is used by
	// the server as an epoch or a mutation sequence number depending on
	// the API called.
...
type GetMutationsResponse struct {
	...
	// A non-zero value will be returned by the client in the page_token
	// field of GetMutationsRequest in the following request.
...
var fileDescriptor0 = []byte{
	...
	,
}
