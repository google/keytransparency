...
type User struct {
	...
	AuthorizedKeys *tink_go_proto.Keyset `protobuf:"bytes,5,opt,name=authorized_keys,json=authorizedKeys" json:"authorized_keys,omitempty"`
	// status is set when account is part of a batch operation.
	Status               *status.Status `protobuf:"bytes,6,opt,name=status" json:"status,omitempty"`
...
func (*User) Descriptor() ([]byte, []int) {
	return fileDescriptor_type_7ca82516707b9305, []int{0}
}
...
func init() { proto.RegisterFile("type/type.proto", fileDescriptor_type_7ca82516707b9305) }

var fileDescriptor_type_7ca82516707b9305 = []byte{
