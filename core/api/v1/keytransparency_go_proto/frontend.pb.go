...
func (*QueueKeyUpdateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_frontend_eae90708d68a2bf4, []int{0}
}
...
func init() { proto.RegisterFile("v1/frontend.proto", fileDescriptor_frontend_eae90708d68a2bf4) }

var fileDescriptor_frontend_eae90708d68a2bf4 = []byte{
