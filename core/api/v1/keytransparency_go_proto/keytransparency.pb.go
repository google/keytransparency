...
type BatchMapRevision struct {
	...
	MapLeaf              []*MapLeaf `protobuf:"bytes,2,rep,name=map_leaf,json=mapLeaf,proto3" json:"map_leaf,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
func (m *BatchMapRevision) GetMapLeaf() []*MapLeaf {
	if m != nil {
		return m.MapLeaf
	}
	return nil
...
var fileDescriptor_9e925e13aa3e8f7d = []byte{
	...
	,
}
