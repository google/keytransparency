...
type Epoch struct {
	...
	LatestLogRoot *trillian.SignedLogRoot `protobuf:"bytes,3,opt,name=latest_log_root,json=latestLogRoot,proto3" json:"latest_log_root,omitempty"`
...
func (m *Epoch) GetLatestLogRoot() *trillian.SignedLogRoot {
	if m != nil {
...
var fileDescriptor_9e925e13aa3e8f7d = []byte{
	...
	,
}
