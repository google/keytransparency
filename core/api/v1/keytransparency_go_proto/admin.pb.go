...
type Directory struct {
	...
	// By its presence in a response, this directory has not been garbage collected.
...
func (*Directory) Descriptor() ([]byte, []int) {
	return fileDescriptor_admin_739e0bb8f5993ce3, []int{0}
}
...
func (*ListDirectoriesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_admin_739e0bb8f5993ce3, []int{1}
}
...
func (*ListDirectoriesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_admin_739e0bb8f5993ce3, []int{2}
}
...
func (*GetDirectoryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_admin_739e0bb8f5993ce3, []int{3}
}
...
func (dst *GetDirectoryRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetDirectoryRequest.Merge(dst, src)
}
...
func (*CreateDirectoryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_admin_739e0bb8f5993ce3, []int{4}
}
...
func (*DeleteDirectoryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_admin_739e0bb8f5993ce3, []int{5}
}
...
func (*UndeleteDirectoryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_admin_739e0bb8f5993ce3, []int{6}
}
...
func (dst *UndeleteDirectoryRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UndeleteDirectoryRequest.Merge(dst, src)
}
...
func (*GarbageCollectRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_admin_739e0bb8f5993ce3, []int{7}
}
...
func (*GarbageCollectResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_admin_739e0bb8f5993ce3, []int{8}
}
...
type KeyTransparencyAdminClient interface {
	// ListDirectories returns a list of all directories this Key Transparency server
	// operates on.
	...
	// CreateDirectory creates a new Trillian log/map pair.  A unique directoryId must
	// be provided.  To create a new directory with the same name as a previously
	// deleted directory, a user must wait X days until the directory is garbage
	// collected.
	CreateDirectory(ctx context.Context, in *CreateDirectoryRequest, opts ...grpc.CallOption) (*Directory, error)
	// DeleteDirectory marks a directory as deleted.  Directories will be garbage collected
	// after X days.
	DeleteDirectory(ctx context.Context, in *DeleteDirectoryRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	// UndeleteDirectory marks a previously deleted directory as active if it has not
	// already been garbage collected.
	UndeleteDirectory(ctx context.Context, in *UndeleteDirectoryRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	// Fully delete soft-deleted directories that have been soft-deleted before the specified timestamp.
...
func init() { proto.RegisterFile("v1/admin.proto", fileDescriptor_admin_739e0bb8f5993ce3) }

var fileDescriptor_admin_739e0bb8f5993ce3 = []byte{
