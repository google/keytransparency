...
func (*ListMutationsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{14} }
...
func (*ListMutationsResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{15} }
...
type KeyTransparencyServiceClient interface {
	...
	ListMutationsStream(ctx context.Context, in *ListMutationsRequest, opts ...grpc.CallOption) (KeyTransparencyService_ListMutationsStreamClient, error)
...
func (c *keyTransparencyServiceClient) ListMutations(ctx context.Context, in *ListMutationsRequest, opts ...grpc.CallOption) (*ListMutationsResponse, error) {
	out := new(ListMutationsResponse)
	err := grpc.Invoke(ctx, "/google.keytransparency.v1.KeyTransparencyService/ListMutations", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keyTransparencyServiceClient) ListMutationsStream(ctx context.Context, in *ListMutationsRequest, opts ...grpc.CallOption) (KeyTransparencyService_ListMutationsStreamClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_KeyTransparencyService_serviceDesc.Streams[1], c.cc, "/google.keytransparency.v1.KeyTransparencyService/ListMutationsStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &keyTransparencyServiceListMutationsStreamClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type KeyTransparencyService_ListMutationsStreamClient interface {
	Recv() (*MutationProof, error)
	grpc.ClientStream
}

type keyTransparencyServiceListMutationsStreamClient struct {
	grpc.ClientStream
}

func (x *keyTransparencyServiceListMutationsStreamClient) Recv() (*MutationProof, error) {
	m := new(MutationProof)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type KeyTransparencyServiceServer interface {
	...
	// ListMutationsStream is a streaming list of mutations in a specific epoch.
	ListMutationsStream(*ListMutationsRequest, KeyTransparencyService_ListMutationsStreamServer) error
	// GetEntry returns a user's entry in the Merkle Tree.
	//
	// Entries contain signed commitments to a profile, which is also returned.
	// TODO(gbelvin): Replace with GetUser
...
func _KeyTransparencyService_ListMutations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListMutationsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KeyTransparencyServiceServer).ListMutations(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.keytransparency.v1.KeyTransparencyService/ListMutations",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KeyTransparencyServiceServer).ListMutations(ctx, req.(*ListMutationsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _KeyTransparencyService_ListMutationsStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ListMutationsRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(KeyTransparencyServiceServer).ListMutationsStream(m, &keyTransparencyServiceListMutationsStreamServer{stream})
}

type KeyTransparencyService_ListMutationsStreamServer interface {
	Send(*MutationProof) error
	grpc.ServerStream
}

type keyTransparencyServiceListMutationsStreamServer struct {
	grpc.ServerStream
}

func (x *keyTransparencyServiceListMutationsStreamServer) Send(m *MutationProof) error {
	return x.ServerStream.SendMsg(m)
}
...
var _KeyTransparencyService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _KeyTransparencyService_ListMutations_Handler,
		},
		{
			MethodName: "GetEntry",
	...
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _KeyTransparencyService_ListMutationsStream_Handler,
			ServerStreams: true,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	,
}
