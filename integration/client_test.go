...
func TestEmptyGetAndUpdate(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"Insert", false, true, GetNewOutgoingContextWithFakeAuth("bob"), "bob", signers1, authorizedKeys1},
		{"Empty2", false, false, context.Background(), "nocarol", signers1, authorizedKeys1},
		{"Not Empty", true, false, context.Background(), "bob", signers1, authorizedKeys1},
		{"Update", true, true, GetNewOutgoingContextWithFakeAuth("bob"), "bob", signers1, authorizedKeys1},
		{"Update, changing keys", true, true, GetNewOutgoingContextWithFakeAuth("bob"), "bob", signers2, authorizedKeys2},
		{"Update, using new keys", true, true, GetNewOutgoingContextWithFakeAuth("bob"), "bob", signers3, authorizedKeys3},
	} {
