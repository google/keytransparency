...
func (c *Commitments) Write(ctx context.Context, commitment []byte, committed *pbtypes.Committed) error {
	tx, err := c.db.Begin()
	if err != nil {
		return err
	}
...
func (c *Commitments) Read(ctx context.Context, commitment []byte) (*pbtypes.Committed, error) {
