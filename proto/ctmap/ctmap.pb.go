...
import fmt "fmt"
import math "math"
import protobuf "github.com/google/key-transparency/proto/protobuf"
...
type MapHead struct {
	...
	IssueTime *protobuf.Timestamp `protobuf:"bytes,4,opt,name=issue_time,json=issueTime" json:"issue_time,omitempty"`
}
...
func (m *MapHead) GetIssueTime() *protobuf.Timestamp {
	if m != nil {
		return m.IssueTime
	}
	return nil
...
var fileDescriptor0 = []byte{
	...
	,
}
